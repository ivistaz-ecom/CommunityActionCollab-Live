  ...
  return (
    <>
          ...
          <Row>
            <Col style={{ background: "#3690C0" }} className="" sm={12} lg={3}>
              <div
                ...
                style={{ background: "#3690C0" }}
              >
                <Image
                  src="/images/015-Build-Blockchain.svg"
                  class=""
                  alt="..."
                  width={80}
                  height=
                ...
                <div class="card-body">
                  ...
                  <p class="card-text text-white fs-5 fw-light">
                    Functional governance systems that cause dynamic network
                    effects, with nodes to actively address the needs of the
                    vulnerable and enable human capital for emergency response.
                  </p>
                </div>
              </div>
            </Col>
              ...
              >
                ...
                <div class="card-body">
                  ...
                  <p class="card-text fs-5 fw-light">
                    Significant policy and practice changes. Amplify
                    components/issues through global collaboration.
                  </p>
                </div>
              </div>
            </Col>
      ...
      <Container className="mt-4 text-center">
        <Link href="/action" className="btn btn-action">
          LEARN MORE
        </Link>
      </Container>
    </>
